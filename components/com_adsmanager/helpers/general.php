...
class JHTMLAdsmanagerGeneral
{
	...
	function endTemplate() {
		echo '<div class="clear" style="margin:1em 0;"><a href="http://www.joomprod.com" title="'.JText::_('ADSMANAGER_CLASSIFIED_SOFTWARE').'">'.JText::_('ADSMANAGER_CLASSIFIED_SOFTWARE').'</a> powered by Juloa.com</div>';
	}
}
