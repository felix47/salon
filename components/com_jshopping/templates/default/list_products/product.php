...
<tr>
    <td class="image">
		...
		<a title="<?php print htmlspecialchars($product->name);?>" href="<?php print $product->image;?>" class="zoom" data-rel="prettyPhoto"><i class="fa fa-search"></i></a>
        <?php }?>
    ...
    <td class="info">
        ...
        <div class="buttons">
            ...
            <a class="button_buy" title="Add to Cart" href="<?php print $product->buy_link?>"><?php print _JSHOP_BUY?></a> 
            <?php }?>
