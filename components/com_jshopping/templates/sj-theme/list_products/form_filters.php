...
<div class="block_sorting_count_to_page">
    ...
    <?php if ($this->config->show_count_select_products){?>
        <span class="box_products_count_to_page"><?php print _JSHOP_DISPLAY_NUMBER."<label class='select-mask'>".$this->product_count.'</label>'?> <p><?php print _JSHOP_DISPLAY_PERPAGE ?></p></span> 
    <?php }?>
</div>
<?php }?>
