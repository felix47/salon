        ...
        <div class="cpanel-theme">
				...
				<div class="panel-group">
                    ...
                    <div class="panel-theme-color">
						...
						<span data-placement="top" title="Grass"     class="theme-color grass<?php echo ($templateColor=='grass')?' active':'';?>">Grass</span>
						<span data-placement="top" title="Grapefruit"   class="theme-color grapefruit<?php echo ($templateColor=='grapefruit')?' active':'';?>">Grapefruit</span>
						<span data-placement="top" title="Green" class="theme-color green<?php echo ($templateColor=='green')?' active':'';?>">Green</span>
						<span data-placement="top" title="Lavender"   class="theme-color lavender<?php echo ($templateColor=='lavender')?' active':'';?>">Lavender</span>
						<span data-placement="top" title="Oranges"  class="theme-color oranges<?php echo ($templateColor=='oranges')?' active':'';?>">Oranges</span>
						<span data-placement="top" title="Pink" style="clear:both;" class="theme-color pink<?php echo ($templateColor=='pink')?' active':'';?>">Pink</span>
