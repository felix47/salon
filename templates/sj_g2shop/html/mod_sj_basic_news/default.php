...
?>
	...
	<div id="<?php echo $uniquied?>" class="sj-basic-news">
		<div class="bs-items">
			...
			?>
			<div class="bs-item cf <?php echo $show_line.' '.$last_class.' '.$first_class; ?>">
				<?php if($img){?>
				<div class="bs-image">
					<a href="<?php echo SjBasicNewsHelper::imageSrc($img); ?>" title="" data-rel="prettyPhoto">
			        		<?php
				...
				<div class="bs-content">
					...
					<div class="bs-cat-date">
						...
						<span class="bs-date"><?php echo JHtml::date($items->created, 'd/m/y'); ?></span>
						<?php }?>
					</div>
					<?php }?>
		...
		<a href="#" class="readmore"><?php echo JText::_('READ_MORE'); ?></a>
	</div>
