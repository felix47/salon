			...
			<div class="el-inner">
				...
				<div class="el-info-contact">
					...
					<div class="info-address cf">
						...
						<span class="info-label address" data-label="<?php echo JText::_('ADD_LABEL') ?>"> </br> <p><?php echo $address; ?></p></span>
					</div>
					...
					<div class="info-mail cf">
						...
						<span class="info-label" data-label="<?php echo JText::_('MAIL_LABEL') ?>"></span>
						<a href="mailto:<?php //echo $mail_to; ?>"> <p><?php echo $mail_to; ?></p></a>
					</div>
					<?php }
					...
					<div class="info-mobie cf">
						...
						<span class="info-label" data-label="<?php echo JText::_('TEL_LABEL') ?>"></br> <p><?php echo $mobile; ?></p></span>
					</div>
					<?php } ?>
				</div>
			</div>
