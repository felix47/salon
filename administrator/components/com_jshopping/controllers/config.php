...
class JshoppingControllerConfig extends JControllerLegacy{
    ...
    function save(){
		...
		if ($tab == 10){
            ...
            if (!file_exists(JPATH_ROOT.'/components/com_jshopping/js/jquery/jquery-'.$post['load_jquery_version'].'.min.js')){
                JError::raiseNotice('', "Error load file: components/com_jshopping/js/jquery/jquery-".$post['load_jquery_version'].".min.js");
            }
		}
