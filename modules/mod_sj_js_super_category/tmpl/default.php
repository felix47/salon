...
if (!empty($list)) {
	...
	$class_spcat = 'spcat00-' . $params->get('nb-column1', 6) . ' spcat01-' . $params->get('nb-column1', 6) . ' spcat02-' . $params->get('nb-column2', 4) . ' spcat03-' . $params->get('nb-column3', 2) . ' spcat04-' . $params->get('nb-column4', 1);
		...
		<div class="spcat-wrap ">
			...
			<div class="spcat-items-container"><!--Begin Items-->
				...
				<div class="spcat-loadmore"
					 ...
					 data-field_order="<?php echo $items->id; ?>"
					 data-rl_start="<?php echo $params->get('count_products', 2) ?>"
